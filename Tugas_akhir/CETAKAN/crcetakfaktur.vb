...
Public Class crcetakfaktur
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tugas_akhir.crcetakfaktur.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_xnofaktur() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedcrcetakfaktur
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crcetakfaktur = New crcetakfaktur
        rpt.Site = Me.Site
        Return rpt
    End Function
