...
Public Class crlappemesanankendaraan
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "crlappemesanankendaraan.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tugas_akhir.crlappemesanankendaraan.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_xtgl1() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_xtgl2() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedcrlappemesanankendaraan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crlappemesanankendaraan = New crlappemesanankendaraan
        rpt.Site = Me.Site
        Return rpt
    End Function
