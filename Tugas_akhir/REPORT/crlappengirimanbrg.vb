...
Public Class crlappengirimanbrg
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tugas_akhir.crlappengirimanbrg.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrlappengirimanbrg
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crlappengirimanbrg = New crlappengirimanbrg
        rpt.Site = Me.Site
        Return rpt
    End Function
