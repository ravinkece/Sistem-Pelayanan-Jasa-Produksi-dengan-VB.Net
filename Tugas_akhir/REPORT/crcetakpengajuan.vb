...
Public Class crcetakpengajuan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tugas_akhir.crcetakpengajuan.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_kd_pengajuan() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedcrcetakpengajuan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crcetakpengajuan = New crcetakpengajuan
        rpt.Site = Me.Site
        Return rpt
    End Function
