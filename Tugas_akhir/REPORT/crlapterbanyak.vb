...
Public Class crlapterbanyak
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tugas_akhir.crlapterbanyak.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrlapterbanyak
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crlapterbanyak = New crlapterbanyak
        rpt.Site = Me.Site
        Return rpt
    End Function
